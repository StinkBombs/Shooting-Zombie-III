...
player = createSprite(windowWidth-1700, windowHeight-300, 50, 50);
 player.addImage(shooterImg)
   ...
   heart1 = createSprite(windowWidth-150,100,20,20)
   heart1.visible = false
    heart1.addImage("heart1",heart1Img)
    heart1.scale = 0.4

    heart2 = createSprite(windowWidth-100,100,20,20)
    heart2.visible = false
    heart2.addImage("heart2",heart2Img)
    heart2.scale = 0.4

    heart3 = createSprite(windowWidth-150,100,20,20)
...
if(keyWentDown("space")){
  bullet = createSprite(windowWidth-1600,player.y-30,20,10)
  bullet.velocityX = 20
